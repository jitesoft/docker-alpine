...
LABEL maintainer="Johannes Tegnér <johannes@jitesoft.com>" \
      ...
      maintainer.repo.type="git" \
      maintainer.repo.uri="https://gitlab.com/jitesoft/dockerfiles/alpine" \
      maintainer.repo.issues="https://gitlab.com/jitesoft/dockerfiles/alpine/issues" \
